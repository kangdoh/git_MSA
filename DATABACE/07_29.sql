...
CREATE TABLE Orders(
    ...
    saleprice INTEGER,
    orderdate DATE,
    // 다른 아이디 Customer에 있는 custid를 가져와서 사용하겠다.
    // 연결하는 부분이다.
		// 주문자 정보의 아이디만 가지고 있다가 
...
INSERT INTO Orders VALUES (2, 1, 3, 21000, S
TR_TO_DATE('2024-07-03','%Y-%m-%d'));
...
select publisher, bookname from Customer;


where bookname like '축구의 역사'
where bookname like '축구%' // 축구~ 인 제목을 찾는 경우
where bookname like '%축구' // ~축구 인 제목을 찾는 경우
where bookname like '축구' // 제목이 딱 축구를 찾는 경우
